...
class WorkoutForm(FlaskForm):
    ...
    areaOfFocus = SelectMultipleField("Area of Focus: ", choices=[('', 'Select an Area of Focus'), ('Abs', 'Core Improvement'), ('Chest', 'Chest'), ('Back', 'Back'), ('Biceps', 'Biceps'), ('Triceps', 'Triceps'), (
        'Shoulders', 'Shoulders'), ('Legs', 'Legs')], validators=[InputRequired()])
